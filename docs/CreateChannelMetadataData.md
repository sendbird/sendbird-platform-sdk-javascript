# SendbirdPlatformSdk.CreateChannelMetadataData
...
**includeTs** | **Boolean** | Determines whether to include the timestamp of when a metadata has been created in the response. (Default: false) | 
