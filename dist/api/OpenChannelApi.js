  ...
  */
  ...
  _createClass(OpenChannelApi, [{
    ...
    value: function ocCreateChannelWithHttpInfo(apiToken, opts) {
      opts = opts || {};
      var postBody = opts['ocCreateChannelData']; // verify the required parameter 'apiToken' is set
    ...
    value: function ocRegisterOperatorsWithHttpInfo(apiToken, channelUrl, opts) {
      opts = opts || {};
      var postBody = opts['ocRegisterOperatorsData']; // verify the required parameter 'apiToken' is set
    ...
    value: function ocUpdateChannelByUrlWithHttpInfo(apiToken, channelUrl, opts) {
      opts = opts || {};
      var postBody = opts['ocUpdateChannelByUrlData']; // verify the required parameter 'apiToken' is set
