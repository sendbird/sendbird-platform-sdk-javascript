...
var UpdateHmsPushConfigurationByIdResponse = /*#__PURE__*/function () {
   ...
   */
  function UpdateHmsPushConfigurationByIdResponse() {
    _classCallCheck(this, UpdateHmsPushConfigurationByIdResponse);

    UpdateHmsPushConfigurationByIdResponse.initialize(this);
  }
  /**
  ...
  _createClass(UpdateHmsPushConfigurationByIdResponse, null, [{
    key: "initialize",
    value: function initialize(obj) {}
    /**
     * Constructs a <code>UpdateHmsPushConfigurationByIdResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateHmsPushConfigurationByIdResponse} obj Optional instance to populate.
     * @return {module:model/UpdateHmsPushConfigurationByIdResponse} The populated <code>UpdateHmsPushConfigurationByIdResponse</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new UpdateHmsPushConfigurationByIdResponse();
