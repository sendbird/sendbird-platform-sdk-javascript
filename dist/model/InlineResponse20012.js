...
var _InlineResponse20012PushConfigurations = _interopRequireDefault(require("./InlineResponse20012PushConfigurations"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('push_configurations')) {
          obj['push_configurations'] = _ApiClient["default"].convertToType(data['push_configurations'], [_InlineResponse20012PushConfigurations["default"]]);
        }
      }
