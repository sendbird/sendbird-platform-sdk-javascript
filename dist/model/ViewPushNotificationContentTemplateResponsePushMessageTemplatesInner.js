...
var ViewPushNotificationContentTemplateResponsePushMessageTemplatesInner = /*#__PURE__*/function () {
   ...
   */
  _createClass(ViewPushNotificationContentTemplateResponsePushMessageTemplatesInner, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('push_message_preview')) {
          obj['push_message_preview'] = _ListPushNotificationContentTemplatesResponsePushMessageTemplatesInnerTemplate["default"].constructFromObject(data['push_message_preview']);
        }
      }
      return obj;
    }
...
var _default = ViewPushNotificationContentTemplateResponsePushMessageTemplatesInner;
