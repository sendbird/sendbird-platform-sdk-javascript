...
var ReportChannelByUrlData = /*#__PURE__*/function () {
   ...
   */
  function ReportChannelByUrlData(channelType, channelUrl, reportCategory, reportingUserId, reportDescription) {
  ...
  _createClass(ReportChannelByUrlData, null, [{
    key: "initialize",
    value: function initialize(obj, channelType, channelUrl, reportCategory, reportingUserId, reportDescription) {
