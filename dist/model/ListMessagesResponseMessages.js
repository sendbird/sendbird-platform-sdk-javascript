...
var _ListMessagesResponseUser = _interopRequireDefault(require("./ListMessagesResponseUser"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('user')) {
          obj['user'] = _ListMessagesResponseUser["default"].constructFromObject(data['user']);
        }
        ...
        if (data.hasOwnProperty('mentioned_users')) {
          obj['mentioned_users'] = _ApiClient["default"].convertToType(data['mentioned_users'], [_ListMessagesResponseUser["default"]]);
        }
