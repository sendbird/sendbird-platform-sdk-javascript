...
var ReportChannelByUrlResponse = /*#__PURE__*/function () {
  ...
  function ReportChannelByUrlResponse() {
    _classCallCheck(this, ReportChannelByUrlResponse);

    ReportChannelByUrlResponse.initialize(this);
  }
  /**
  ...
  _createClass(ReportChannelByUrlResponse, null, [{
    key: "initialize",
    value: function initialize(obj) {}
    /**
     * Constructs a <code>ReportChannelByUrlResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReportChannelByUrlResponse} obj Optional instance to populate.
     * @return {module:model/ReportChannelByUrlResponse} The populated <code>ReportChannelByUrlResponse</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ReportChannelByUrlResponse();
...
ReportChannelByUrlResponse.prototype['report_category'] = undefined;
/**
 * @member {module:model/SendBirdUser} reporting_user
 */

ReportChannelByUrlResponse.prototype['reporting_user'] = undefined;
/**
 * @member {module:model/SendBirdUser} offending_user
 */

ReportChannelByUrlResponse.prototype['offending_user'] = undefined;
/**
 * @member {module:model/SendBirdMessageResponse} reported_message
 */

ReportChannelByUrlResponse.prototype['reported_message'] = undefined;
/**
 * @member {module:model/SendBirdChannelResponse} channel
 */

ReportChannelByUrlResponse.prototype['channel'] = undefined;
/**
 * @member {String} report_description
 */

ReportChannelByUrlResponse.prototype['report_description'] = undefined;
/**
 * @member {Number} created_at
 */

ReportChannelByUrlResponse.prototype['created_at'] = undefined;
var _default = ReportChannelByUrlResponse;
