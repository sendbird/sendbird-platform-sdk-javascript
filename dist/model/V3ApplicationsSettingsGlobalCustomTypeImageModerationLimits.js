 ...
 * @version 1.0.3
 */
var V3ApplicationsSettingsGlobalCustomTypeImageModerationLimits = /*#__PURE__*/function () {
  /**
   ...
   */
  function V3ApplicationsSettingsGlobalCustomTypeImageModerationLimits() {
    _classCallCheck(this, V3ApplicationsSettingsGlobalCustomTypeImageModerationLimits);
  ...
  _createClass(V3ApplicationsSettingsGlobalCustomTypeImageModerationLimits, null, [{
    key: "initialize",
  ...
  return V3ApplicationsSettingsGlobalCustomTypeImageModerationLimits;
}();
/**
 * @member {Number} adult
 */
...
var _default = V3ApplicationsSettingsGlobalCustomTypeImageModerationLimits;
