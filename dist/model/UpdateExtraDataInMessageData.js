...
var UpdateExtraDataInMessageData = /*#__PURE__*/function () {
   ...
   */
  function UpdateExtraDataInMessageData(channelType, channelUrl, messageId, sortedMetaarray, mode, upsert, metaarray) {
  ...
  _createClass(UpdateExtraDataInMessageData, null, [{
    key: "initialize",
    value: function initialize(obj, channelType, channelUrl, messageId, sortedMetaarray, mode, upsert, metaarray) {
