 ...
 * @version 0.0.16
 */
var ConfigureAutoEventDataAutoEventMessage = /*#__PURE__*/function () {
  /**
  ...
  function ConfigureAutoEventDataAutoEventMessage() {
    _classCallCheck(this, ConfigureAutoEventDataAutoEventMessage);
   ...
   */
  _createClass(ConfigureAutoEventDataAutoEventMessage, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('user_leave')) {
          obj['user_leave'] = _ApiClient["default"].convertToType(data['user_leave'], Object);
        }
        if (data.hasOwnProperty('user_join')) {
          obj['user_join'] = _ApiClient["default"].convertToType(data['user_join'], Object);
        }
        if (data.hasOwnProperty('channel_create')) {
          obj['channel_create'] = _ApiClient["default"].convertToType(data['channel_create'], Object);
        }
        if (data.hasOwnProperty('channel_change')) {
          obj['channel_change'] = _ApiClient["default"].convertToType(data['channel_change'], Object);
        }
      }
      return obj;
    }
...
var _default = ConfigureAutoEventDataAutoEventMessage;
