...
var _InlineResponse20044Statistics = _interopRequireDefault(require("./InlineResponse20044Statistics"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('statistics')) {
          obj['statistics'] = _ApiClient["default"].convertToType(data['statistics'], [_InlineResponse20044Statistics["default"]]);
        }
