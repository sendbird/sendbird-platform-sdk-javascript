...
var AddExtraDataToMessageData = /*#__PURE__*/function () {
   ...
   */
  function AddExtraDataToMessageData(channelType, channelUrl, messageId, sortedMetaarray, metaarray) {
  ...
  _createClass(AddExtraDataToMessageData, null, [{
    key: "initialize",
    value: function initialize(obj, channelType, channelUrl, messageId, sortedMetaarray, metaarray) {
