 ...
 * @version 1.0.3
 */
var V3ApplicationsSettingsGlobalCustomTypeProfanityFilterRegexFilters = /*#__PURE__*/function () {
  /**
   ...
   */
  function V3ApplicationsSettingsGlobalCustomTypeProfanityFilterRegexFilters() {
    _classCallCheck(this, V3ApplicationsSettingsGlobalCustomTypeProfanityFilterRegexFilters);
  ...
  _createClass(V3ApplicationsSettingsGlobalCustomTypeProfanityFilterRegexFilters, null, [{
    key: "initialize",
  ...
  return V3ApplicationsSettingsGlobalCustomTypeProfanityFilterRegexFilters;
}();
/**
 * @member {String} regex
 */
...
var _default = V3ApplicationsSettingsGlobalCustomTypeProfanityFilterRegexFilters;
