...
var CreateBotData = /*#__PURE__*/function () {
   ...
   */
  function CreateBotData(botUserid, botNickname, botProfileUrl, botType, botCallbackUrl, isPrivacyMode, enableMarkAsRead, showMember, channelInvitationPreference) {
  ...
  _createClass(CreateBotData, null, [{
    key: "initialize",
    value: function initialize(obj, botUserid, botNickname, botProfileUrl, botType, botCallbackUrl, isPrivacyMode, enableMarkAsRead, showMember, channelInvitationPreference) {
