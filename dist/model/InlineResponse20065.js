...
var _InlineResponse20065Bots = _interopRequireDefault(require("./InlineResponse20065Bots"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('bots')) {
          obj['bots'] = _ApiClient["default"].convertToType(data['bots'], [_InlineResponse20065Bots["default"]]);
        }
