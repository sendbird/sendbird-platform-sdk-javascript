...
var CreateUserData = /*#__PURE__*/function () {
   ...
   */
  function CreateUserData(userId, nickname, profileUrl, profileFile, issueAccessToken, issueSessionToken, sessionTokenExpiresAt, discoveryKeys, metadata) {
  ...
  _createClass(CreateUserData, null, [{
    key: "initialize",
    value: function initialize(obj, userId, nickname, profileUrl, profileFile, issueAccessToken, issueSessionToken, sessionTokenExpiresAt, discoveryKeys, metadata) {
      obj['user_id'] = userId;
