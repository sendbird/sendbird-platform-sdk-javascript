...
var EnableReactionsResponse = /*#__PURE__*/function () {
   ...
   */
  function EnableReactionsResponse() {
    _classCallCheck(this, EnableReactionsResponse);
  ...
  _createClass(EnableReactionsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('reactions')) {
          obj['reactions'] = _ApiClient["default"].convertToType(data['reactions'], 'Boolean');
        }
      }
