...
var _InlineResponse20057EmojiCategories = _interopRequireDefault(require("./InlineResponse20057EmojiCategories"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('emoji_categories')) {
          obj['emoji_categories'] = _ApiClient["default"].convertToType(data['emoji_categories'], [_InlineResponse20057EmojiCategories["default"]]);
        }
      }
