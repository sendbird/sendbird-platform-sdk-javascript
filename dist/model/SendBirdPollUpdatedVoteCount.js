...
var SendBirdPollUpdatedVoteCount = /*#__PURE__*/function () {
  ...
  function SendBirdPollUpdatedVoteCount() {
    _classCallCheck(this, SendBirdPollUpdatedVoteCount);
  ...
  _createClass(SendBirdPollUpdatedVoteCount, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('option_id')) {
          obj['option_id'] = _ApiClient["default"].convertToType(data['option_id'], 'Number');
        }
...
var _default = SendBirdPollUpdatedVoteCount;
