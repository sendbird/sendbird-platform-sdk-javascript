 ...
 * @version 1.0.0
 */
var ListMessagesResponseUserMetadata = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListMessagesResponseUserMetadata</code>.
   * @alias module:model/ListMessagesResponseUserMetadata
   */
  function ListMessagesResponseUserMetadata() {
    _classCallCheck(this, ListMessagesResponseUserMetadata);
  ...
  _createClass(ListMessagesResponseUserMetadata, null, [{
    key: "initialize",
  ...
  return ListMessagesResponseUserMetadata;
}();
/**
 * @member {String} anyOf
 */
...
var _default = ListMessagesResponseUserMetadata;
