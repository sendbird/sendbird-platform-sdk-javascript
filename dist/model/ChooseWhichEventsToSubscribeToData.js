...
var ChooseWhichEventsToSubscribeToData = /*#__PURE__*/function () {
   ...
   */
  function ChooseWhichEventsToSubscribeToData(enabled, url, includeMembers, enabledEvents) {
  ...
  _createClass(ChooseWhichEventsToSubscribeToData, null, [{
    key: "initialize",
    value: function initialize(obj, enabled, url, includeMembers, enabledEvents) {
      obj['enabled'] = enabled;
      obj['url'] = url;
