 ...
 * @version 2.0.0
 */
var RegisterOperatorsToAGroupChannelRequest = /*#__PURE__*/function () {
  /**
   ...
   */
  function RegisterOperatorsToAGroupChannelRequest(operatorIds) {
    _classCallCheck(this, RegisterOperatorsToAGroupChannelRequest);
   ...
   */
  return _createClass(RegisterOperatorsToAGroupChannelRequest, null, [{
    key: "initialize",
    value: function initialize(obj, operatorIds) {
...
var _default = exports["default"] = RegisterOperatorsToAGroupChannelRequest;