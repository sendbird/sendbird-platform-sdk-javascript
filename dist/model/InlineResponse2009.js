...
var _InlineResponse2009PeakConnections = _interopRequireDefault(require("./InlineResponse2009PeakConnections"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('peak_connections')) {
          obj['peak_connections'] = _ApiClient["default"].convertToType(data['peak_connections'], [_InlineResponse2009PeakConnections["default"]]);
        }
      }
