 ...
 * @version 1.0.3
 */
var SendBirdAdditionalProperties = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>SendBirdAdditionalProperties</code>.
   * @alias module:model/SendBirdAdditionalProperties
   */
  function SendBirdAdditionalProperties() {
    _classCallCheck(this, SendBirdAdditionalProperties);
  ...
  _createClass(SendBirdAdditionalProperties, null, [{
    key: "initialize",
  ...
  return SendBirdAdditionalProperties;
}();

var _default = SendBirdAdditionalProperties;
