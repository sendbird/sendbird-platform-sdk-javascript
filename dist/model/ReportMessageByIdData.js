...
var ReportMessageByIdData = /*#__PURE__*/function () {
   ...
   */
  function ReportMessageByIdData(channelType, channelUrl, messageId, reportCategory, offendingUserId, reportingUserId, reportDescription) {
  ...
  _createClass(ReportMessageByIdData, null, [{
    key: "initialize",
    value: function initialize(obj, channelType, channelUrl, messageId, reportCategory, offendingUserId, reportingUserId, reportDescription) {
