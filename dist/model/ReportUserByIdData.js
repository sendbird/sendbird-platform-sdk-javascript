...
var ReportUserByIdData = /*#__PURE__*/function () {
   ...
   */
  function ReportUserByIdData(offendingUserId, channelType, channelUrl, reportCategory, reportingUserId, reportDescription) {
  ...
  _createClass(ReportUserByIdData, null, [{
    key: "initialize",
    value: function initialize(obj, offendingUserId, channelType, channelUrl, reportCategory, reportingUserId, reportDescription) {
