...
var _InlineResponse20070ReportLogs = _interopRequireDefault(require("./InlineResponse20070ReportLogs"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('report_logs')) {
          obj['report_logs'] = _ApiClient["default"].convertToType(data['report_logs'], [_InlineResponse20070ReportLogs["default"]]);
        }
