...
class GcUpdateChannelByUrlData {
     ...
     */
    constructor(channelUrl, name, coverUrl, coverFile, customType, data, isDistinct, isPublic, accessCode, operatorIds) { 
     ...
     */
    static initialize(obj, channelUrl, name, coverUrl, coverFile, customType, data, isDistinct, isPublic, accessCode, operatorIds) { 
...
export default GcUpdateChannelByUrlData;
