...
class GcCreateChannelData {
     ...
     */
    constructor(userIds, users, name, channelUrl, coverUrl, coverFile, customType, data, isDistinct, isPublic, isSuper, isEphemeral, accessCode, inviterId, strict, invitationStatus, hiddenStatus, operatorIds, blockSdkUserChannelJoin) { 
     ...
     */
    static initialize(obj, userIds, users, name, channelUrl, coverUrl, coverFile, customType, data, isDistinct, isPublic, isSuper, isEphemeral, accessCode, inviterId, strict, invitationStatus, hiddenStatus, operatorIds, blockSdkUserChannelJoin) { 
