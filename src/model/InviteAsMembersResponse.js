...
class InviteAsMembersResponse {
    ...
    constructor(channelUrl) { 
        SendbirdGroupChannel.initialize(this, channelUrl);InviteAsMembersResponseAllOf.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            InviteAsMembersResponseAllOf.constructFromObject(data, obj);
...
export default InviteAsMembersResponse;
