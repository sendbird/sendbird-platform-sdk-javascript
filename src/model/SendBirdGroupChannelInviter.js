 ...
 * @version 0.0.14
 */
class SendBirdGroupChannelInviter {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            SendBirdUser.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('session_tokens')) {
                obj['session_tokens'] = ApiClient.convertToType(data['session_tokens'], [Object]);
            }
...
export default SendBirdGroupChannelInviter;
