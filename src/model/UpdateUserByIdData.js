...
class UpdateUserByIdData {
     ...
     */
    constructor(userId, nickname, profileUrl, profileFile, issueAccessToken, issueSessionToken, sessionTokenExpiresAt, isActive, lastSeenAt, discoveryKeys, preferredLanguages, leaveAllWhenDeactivated) { 
     ...
     */
    static initialize(obj, userId, nickname, profileUrl, profileFile, issueAccessToken, issueSessionToken, sessionTokenExpiresAt, isActive, lastSeenAt, discoveryKeys, preferredLanguages, leaveAllWhenDeactivated) { 
        obj['user_id'] = userId;
