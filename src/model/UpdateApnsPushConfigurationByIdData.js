 ...
 * @version 1.0.3
 */
class UpdateApnsPushConfigurationByIdData {
    /**
     ...
     */
    constructor(providerId, apnsCert, apnsCertEnvType, apnsCertPassword, hasUnreadCountBadge, contentAvailable, mutableContent, pushSound, apnsType) { 
     ...
     */
    static initialize(obj, providerId, apnsCert, apnsCertEnvType, apnsCertPassword, hasUnreadCountBadge, contentAvailable, mutableContent, pushSound, apnsType) { 
...
export default UpdateApnsPushConfigurationByIdData;
