...
class CreateABotRequest {
     ...
     */
    constructor(botCallbackUrl, botNickname, botProfileUrl, botType, botUserid, isPrivacyMode) { 
     ...
     */
    static initialize(obj, botCallbackUrl, botNickname, botProfileUrl, botType, botUserid, isPrivacyMode) { 
...
export default CreateABotRequest;
