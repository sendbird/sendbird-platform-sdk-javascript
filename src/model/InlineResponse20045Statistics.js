...
/**
 * The InlineResponse20045Statistics model module.
 * @module model/InlineResponse20045Statistics
 * @version 1.0.0
 */
class InlineResponse20045Statistics {
    /**
     * Constructs a new <code>InlineResponse20045Statistics</code>.
     * @alias module:model/InlineResponse20045Statistics
     */
    constructor() { 
        
        InlineResponse20045Statistics.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse20045Statistics</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse20045Statistics} obj Optional instance to populate.
     * @return {module:model/InlineResponse20045Statistics} The populated <code>InlineResponse20045Statistics</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse20045Statistics();
 ...
 */
InlineResponse20045Statistics.prototype['date_range'] = undefined;

/**
 * @member {Number} canceled_announcement_count
 */
InlineResponse20045Statistics.prototype['canceled_announcement_count'] = undefined;

/**
 * @member {Number} stopped_announcement_count
 */
InlineResponse20045Statistics.prototype['stopped_announcement_count'] = undefined;

/**
 * @member {Number} completed_announcement_count
 */
InlineResponse20045Statistics.prototype['completed_announcement_count'] = undefined;

/**
 * @member {Number} total_announcement_count
 */
InlineResponse20045Statistics.prototype['total_announcement_count'] = undefined;

/**
 * @member {Number} target_channel_count
 */
InlineResponse20045Statistics.prototype['target_channel_count'] = undefined;

/**
 * @member {Number} target_user_count
 */
InlineResponse20045Statistics.prototype['target_user_count'] = undefined;

/**
 * @member {Number} sent_channel_count
 */
InlineResponse20045Statistics.prototype['sent_channel_count'] = undefined;

/**
 * @member {Number} sent_user_count
 */
InlineResponse20045Statistics.prototype['sent_user_count'] = undefined;

/**
 * @member {Number} open_rate
 */
InlineResponse20045Statistics.prototype['open_rate'] = undefined;

/**
 * @member {Number} open_count
 */
InlineResponse20045Statistics.prototype['open_count'] = undefined;
...
export default InlineResponse20045Statistics;
