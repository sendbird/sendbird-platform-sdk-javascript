...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.GetDetailedOpenRateOfAnnouncementByIdResponse();
  });
  ...
  describe('GetDetailedOpenRateOfAnnouncementByIdResponse', function() {
    it('should create an instance of GetDetailedOpenRateOfAnnouncementByIdResponse', function() {
      // uncomment below and update the code to test GetDetailedOpenRateOfAnnouncementByIdResponse
      //var instance = new SendbirdPlatformSdk.GetDetailedOpenRateOfAnnouncementByIdResponse();
      //expect(instance).to.be.a(SendbirdPlatformSdk.GetDetailedOpenRateOfAnnouncementByIdResponse);
    });
