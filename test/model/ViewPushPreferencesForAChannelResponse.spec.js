...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.ViewPushPreferencesForAChannelResponse();
  });
  ...
  describe('ViewPushPreferencesForAChannelResponse', function() {
    it('should create an instance of ViewPushPreferencesForAChannelResponse', function() {
      // uncomment below and update the code to test ViewPushPreferencesForAChannelResponse
      //var instance = new SendbirdPlatformSdk.ViewPushPreferencesForAChannelResponse();
      //expect(instance).to.be.a(SendbirdPlatformSdk.ViewPushPreferencesForAChannelResponse);
    });
