...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.SendBirdAdminMessage();
  });
  ...
  describe('SendBirdAdminMessage', function() {
    it('should create an instance of SendBirdAdminMessage', function() {
      // uncomment below and update the code to test SendBirdAdminMessage
      //var instance = new SendbirdPlatformSdk.SendBirdAdminMessage();
      //expect(instance).to.be.a(SendbirdPlatformSdk.SendBirdAdminMessage);
    });
