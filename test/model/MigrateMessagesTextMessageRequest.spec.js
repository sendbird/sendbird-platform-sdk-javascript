...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.MigrateMessagesTextMessageRequest();
  });
  ...
  describe('MigrateMessagesTextMessageRequest', function() {
    it('should create an instance of MigrateMessagesTextMessageRequest', function() {
      // uncomment below and update the code to test MigrateMessagesTextMessageRequest
      //var instance = new SendbirdPlatformSdk.MigrateMessagesTextMessageRequest();
      //expect(instance).to.be.a(SendbirdPlatformSdk.MigrateMessagesTextMessageRequest);
    });
