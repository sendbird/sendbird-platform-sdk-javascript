...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.ListPushConfigurationsResponsePushConfigurations();
  });
  ...
  describe('ListPushConfigurationsResponsePushConfigurations', function() {
    it('should create an instance of ListPushConfigurationsResponsePushConfigurations', function() {
      // uncomment below and update the code to test ListPushConfigurationsResponsePushConfigurations
      //var instance = new SendbirdPlatformSdk.ListPushConfigurationsResponsePushConfigurations();
      //expect(instance).to.be.a(SendbirdPlatformSdk.ListPushConfigurationsResponsePushConfigurations);
    });
