...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.GenerateSecondaryApiTokenData();
  });
  ...
  describe('GenerateSecondaryApiTokenData', function() {
    ...
    it('should have the property HTTP_API_TOKEN (base name: "HTTP_API_TOKEN")', function() {
      // uncomment below and update the code to test the property HTTP_API_TOKEN
      //var instance = new SendbirdPlatformSdk.GenerateSecondaryApiTokenData();
