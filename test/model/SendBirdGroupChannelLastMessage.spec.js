...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.SendBirdGroupChannelLastMessage();
  });
  ...
  describe('SendBirdGroupChannelLastMessage', function() {
    it('should create an instance of SendBirdGroupChannelLastMessage', function() {
      // uncomment below and update the code to test SendBirdGroupChannelLastMessage
      //var instance = new SendbirdPlatformSdk.SendBirdGroupChannelLastMessage();
      //expect(instance).to.be.a(SendbirdPlatformSdk.SendBirdGroupChannelLastMessage);
    });
