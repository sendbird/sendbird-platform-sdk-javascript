...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.SendBirdRestrictionInfo();
  });
  ...
  describe('SendBirdRestrictionInfo', function() {
    it('should create an instance of SendBirdRestrictionInfo', function() {
      // uncomment below and update the code to test SendBirdRestrictionInfo
      //var instance = new SendbirdPlatformSdk.SendBirdRestrictionInfo();
      //expect(instance).to.be.a(SendbirdPlatformSdk.SendBirdRestrictionInfo);
    });
