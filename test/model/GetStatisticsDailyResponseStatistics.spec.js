...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.GetStatisticsDailyResponseStatistics();
  });
  ...
  describe('GetStatisticsDailyResponseStatistics', function() {
    it('should create an instance of GetStatisticsDailyResponseStatistics', function() {
      // uncomment below and update the code to test GetStatisticsDailyResponseStatistics
      //var instance = new SendbirdPlatformSdk.GetStatisticsDailyResponseStatistics();
      //expect(instance).to.be.a(SendbirdPlatformSdk.GetStatisticsDailyResponseStatistics);
    });
