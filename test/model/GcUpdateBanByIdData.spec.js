...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.GcUpdateBanByIdData();
  });
  ...
  describe('GcUpdateBanByIdData', function() {
    ...
    it('should have the property bannedUserId (base name: "banned_user_id")', function() {
      // uncomment below and update the code to test the property bannedUserId
      //var instance = new SendbirdPlatformSdk.GcUpdateBanByIdData();
      //expect(instance).to.be();
    });
