...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.SendBirdPollVoterListQuery();
  });
  ...
  describe('SendBirdPollVoterListQuery', function() {
    it('should create an instance of SendBirdPollVoterListQuery', function() {
      // uncomment below and update the code to test SendBirdPollVoterListQuery
      //var instance = new SendbirdPlatformSdk.SendBirdPollVoterListQuery();
      //expect(instance).to.be.a(SendbirdPlatformSdk.SendBirdPollVoterListQuery);
    });
