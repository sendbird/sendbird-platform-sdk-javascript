...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.SendBirdOGMetaData();
  });
  ...
  describe('SendBirdOGMetaData', function() {
    it('should create an instance of SendBirdOGMetaData', function() {
      // uncomment below and update the code to test SendBirdOGMetaData
