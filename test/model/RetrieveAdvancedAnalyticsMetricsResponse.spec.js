...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.RetrieveAdvancedAnalyticsMetricsResponse();
  });
  ...
  describe('RetrieveAdvancedAnalyticsMetricsResponse', function() {
    it('should create an instance of RetrieveAdvancedAnalyticsMetricsResponse', function() {
      // uncomment below and update the code to test RetrieveAdvancedAnalyticsMetricsResponse
      //var instance = new SendbirdPlatformSdk.RetrieveAdvancedAnalyticsMetricsResponse();
      //expect(instance).to.be.a(SendbirdPlatformSdk.RetrieveAdvancedAnalyticsMetricsResponse);
    });
