...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.ListPushNotificationContentTemplatesResponse();
  });
  ...
  describe('ListPushNotificationContentTemplatesResponse', function() {
    it('should create an instance of ListPushNotificationContentTemplatesResponse', function() {
      // uncomment below and update the code to test ListPushNotificationContentTemplatesResponse
