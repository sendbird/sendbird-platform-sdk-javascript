...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.UpdatePushPreferencesForAChannelResponse();
  });
  ...
  describe('UpdatePushPreferencesForAChannelResponse', function() {
    it('should create an instance of UpdatePushPreferencesForAChannelResponse', function() {
      // uncomment below and update the code to test UpdatePushPreferencesForAChannelResponse
      //var instance = new SendbirdPlatformSdk.UpdatePushPreferencesForAChannelResponse();
      //expect(instance).to.be.a(SendbirdPlatformSdk.UpdatePushPreferencesForAChannelResponse);
    });
