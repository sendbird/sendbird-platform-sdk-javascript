...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.GetDetailedOpenStatusOfAnnouncementByIdResponse();
  });
  ...
  describe('GetDetailedOpenStatusOfAnnouncementByIdResponse', function() {
    it('should create an instance of GetDetailedOpenStatusOfAnnouncementByIdResponse', function() {
      // uncomment below and update the code to test GetDetailedOpenStatusOfAnnouncementByIdResponse
