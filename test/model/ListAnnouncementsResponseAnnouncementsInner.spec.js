...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.ListAnnouncementsResponseAnnouncementsInner();
  });
  ...
  describe('ListAnnouncementsResponseAnnouncementsInner', function() {
    it('should create an instance of ListAnnouncementsResponseAnnouncementsInner', function() {
      // uncomment below and update the code to test ListAnnouncementsResponseAnnouncementsInner
      //var instance = new SendbirdPlatformSdk.ListAnnouncementsResponseAnnouncementsInner();
      //expect(instance).to.be.a(SendbirdPlatformSdk.ListAnnouncementsResponseAnnouncementsInner);
    });
