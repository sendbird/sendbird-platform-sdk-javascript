...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.MuteUsersInChannelsWithCustomChannelTypeData();
  });
  ...
  describe('MuteUsersInChannelsWithCustomChannelTypeData', function() {
    it('should create an instance of MuteUsersInChannelsWithCustomChannelTypeData', function() {
      // uncomment below and update the code to test MuteUsersInChannelsWithCustomChannelTypeData
    ...
    it('should have the property onDemandUpsert (base name: "on_demand_upsert")', function() {
      // uncomment below and update the code to test the property onDemandUpsert
      //var instance = new SendbirdPlatformSdk.MuteUsersInChannelsWithCustomChannelTypeData();
      //expect(instance).to.be();
    });
