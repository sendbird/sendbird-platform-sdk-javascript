...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.CreateUserTokenResponse();
  });
  ...
  describe('CreateUserTokenResponse', function() {
    it('should create an instance of CreateUserTokenResponse', function() {
      // uncomment below and update the code to test CreateUserTokenResponse
