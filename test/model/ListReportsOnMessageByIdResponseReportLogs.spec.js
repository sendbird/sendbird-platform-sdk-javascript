...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.ListReportsOnMessageByIdResponseReportLogs();
  });
  ...
  describe('ListReportsOnMessageByIdResponseReportLogs', function() {
    it('should create an instance of ListReportsOnMessageByIdResponseReportLogs', function() {
      // uncomment below and update the code to test ListReportsOnMessageByIdResponseReportLogs
      //var instance = new SendbirdPlatformSdk.ListReportsOnMessageByIdResponseReportLogs();
      //expect(instance).to.be.a(SendbirdPlatformSdk.ListReportsOnMessageByIdResponseReportLogs);
    });
