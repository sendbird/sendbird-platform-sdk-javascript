...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.AddApnsPushConfigurationResponsePushConfigurations();
  });
  ...
  describe('AddApnsPushConfigurationResponsePushConfigurations', function() {
    it('should create an instance of AddApnsPushConfigurationResponsePushConfigurations', function() {
      // uncomment below and update the code to test AddApnsPushConfigurationResponsePushConfigurations
      //var instance = new SendbirdPlatformSdk.AddApnsPushConfigurationResponsePushConfigurations();
      //expect(instance).to.be.a(SendbirdPlatformSdk.AddApnsPushConfigurationResponsePushConfigurations);
    });
