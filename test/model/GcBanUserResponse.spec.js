...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.GcBanUserResponse();
  });
  ...
  describe('GcBanUserResponse', function() {
    it('should create an instance of GcBanUserResponse', function() {
      // uncomment below and update the code to test GcBanUserResponse
      //var instance = new SendbirdPlatformSdk.GcBanUserResponse();
      //expect(instance).to.be.a(SendbirdPlatformSdk.GcBanUserResponse);
    });
