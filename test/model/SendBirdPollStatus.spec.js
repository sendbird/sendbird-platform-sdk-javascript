...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.SendBirdPollStatus();
  });
  ...
  describe('SendBirdPollStatus', function() {
    it('should create an instance of SendBirdPollStatus', function() {
      // uncomment below and update the code to test SendBirdPollStatus
      //var instance = new SendbirdPlatformSdk.SendBirdPollStatus();
      //expect(instance).to.be.a(SendbirdPlatformSdk.SendBirdPollStatus);
    });
