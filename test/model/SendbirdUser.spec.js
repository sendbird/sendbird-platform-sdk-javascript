...
(function(root, factory) {
  ...
  describe('SendbirdUser', function() {
    ...
    it('should have the property unreadChannelCount (base name: "unread_channel_count")', function() {
      // uncomment below and update the code to test the property unreadChannelCount
      //var instance = new SendbirdPlatformSdk.SendbirdUser();
      //expect(instance).to.be();
    });
