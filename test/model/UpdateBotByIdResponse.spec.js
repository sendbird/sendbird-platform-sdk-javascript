...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.UpdateBotByIdResponse();
  });
  ...
  describe('UpdateBotByIdResponse', function() {
    it('should create an instance of UpdateBotByIdResponse', function() {
      // uncomment below and update the code to test UpdateBotByIdResponse
      //var instance = new SendbirdPlatformSdk.UpdateBotByIdResponse();
      //expect(instance).to.be.a(SendbirdPlatformSdk.UpdateBotByIdResponse);
    });
