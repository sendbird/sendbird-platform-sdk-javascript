...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.UpdateAnnouncementByIdResponse();
  });
  ...
  describe('UpdateAnnouncementByIdResponse', function() {
    it('should create an instance of UpdateAnnouncementByIdResponse', function() {
      // uncomment below and update the code to test UpdateAnnouncementByIdResponse
