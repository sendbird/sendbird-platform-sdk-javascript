...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.SendbirdThumbnail();
  });
  ...
  describe('SendbirdThumbnail', function() {
    it('should create an instance of SendbirdThumbnail', function() {
      // uncomment below and update the code to test SendbirdThumbnail
      //var instance = new SendbirdPlatformSdk.SendbirdThumbnail();
      //expect(instance).to.be.a(SendbirdPlatformSdk.SendbirdThumbnail);
    });
