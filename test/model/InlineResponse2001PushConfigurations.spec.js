...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.InlineResponse2001PushConfigurations();
  });
  ...
  describe('InlineResponse2001PushConfigurations', function() {
    it('should create an instance of InlineResponse2001PushConfigurations', function() {
      // uncomment below and update the code to test InlineResponse2001PushConfigurations
      //var instance = new SendbirdPlatformSdk.InlineResponse2001PushConfigurations();
      //expect(instance).to.be.a(SendbirdPlatformSdk.InlineResponse2001PushConfigurations);
    });
