...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.InviteAsMembersResponseAllOf();
  });
  ...
  describe('InviteAsMembersResponseAllOf', function() {
    it('should create an instance of InviteAsMembersResponseAllOf', function() {
      // uncomment below and update the code to test InviteAsMembersResponseAllOf
