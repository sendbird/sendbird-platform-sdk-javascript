...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.SendBirdMutedInfo();
  });
  ...
  describe('SendBirdMutedInfo', function() {
    it('should create an instance of SendBirdMutedInfo', function() {
      // uncomment below and update the code to test SendBirdMutedInfo
      //var instance = new SendbirdPlatformSdk.SendBirdMutedInfo();
      //expect(instance).to.be.a(SendbirdPlatformSdk.SendBirdMutedInfo);
    });
    ...
    it('should have the property remainingDuration (base name: "remainingDuration")', function() {
