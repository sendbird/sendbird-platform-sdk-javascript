...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.SendBirdGroupChannelCollection();
  });
  ...
  describe('SendBirdGroupChannelCollection', function() {
    it('should create an instance of SendBirdGroupChannelCollection', function() {
      // uncomment below and update the code to test SendBirdGroupChannelCollection
