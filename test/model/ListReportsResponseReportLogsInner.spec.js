...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.ListReportsResponseReportLogsInner();
  });
  ...
  describe('ListReportsResponseReportLogsInner', function() {
    it('should create an instance of ListReportsResponseReportLogsInner', function() {
      // uncomment below and update the code to test ListReportsResponseReportLogsInner
      //var instance = new SendbirdPlatformSdk.ListReportsResponseReportLogsInner();
      //expect(instance).to.be.a(SendbirdPlatformSdk.ListReportsResponseReportLogsInner);
    });
