...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.SendbirdGroupChannelDetailChannel();
  });
  ...
  describe('SendbirdGroupChannelDetailChannel', function() {
    it('should create an instance of SendbirdGroupChannelDetailChannel', function() {
      // uncomment below and update the code to test SendbirdGroupChannelDetailChannel
      //var instance = new SendbirdPlatformSdk.SendbirdGroupChannelDetailChannel();
      //expect(instance).to.be.a(SendbirdPlatformSdk.SendbirdGroupChannelDetailChannel);
    });
