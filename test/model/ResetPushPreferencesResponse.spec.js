...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.ResetPushPreferencesResponse();
  });
  ...
  describe('ResetPushPreferencesResponse', function() {
    it('should create an instance of ResetPushPreferencesResponse', function() {
      // uncomment below and update the code to test ResetPushPreferencesResponse
      //var instance = new SendbirdPlatformSdk.ResetPushPreferencesResponse();
      //expect(instance).to.be.a(SendbirdPlatformSdk.ResetPushPreferencesResponse);
    });
