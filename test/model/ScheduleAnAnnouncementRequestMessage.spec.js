...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.ScheduleAnAnnouncementRequestMessage();
  });
  ...
  describe('ScheduleAnAnnouncementRequestMessage', function() {
    it('should create an instance of ScheduleAnAnnouncementRequestMessage', function() {
      // uncomment below and update the code to test ScheduleAnAnnouncementRequestMessage
