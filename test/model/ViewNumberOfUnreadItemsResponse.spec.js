...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.ViewNumberOfUnreadItemsResponse();
  });
  ...
  describe('ViewNumberOfUnreadItemsResponse', function() {
    it('should create an instance of ViewNumberOfUnreadItemsResponse', function() {
      // uncomment below and update the code to test ViewNumberOfUnreadItemsResponse
      //var instance = new SendbirdPlatformSdk.ViewNumberOfUnreadItemsResponse();
      //expect(instance).to.be.a(SendbirdPlatformSdk.ViewNumberOfUnreadItemsResponse);
    });
