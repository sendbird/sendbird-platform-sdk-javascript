...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.RemoveReactionFromAMessageResponse();
  });
  ...
  describe('RemoveReactionFromAMessageResponse', function() {
    it('should create an instance of RemoveReactionFromAMessageResponse', function() {
      // uncomment below and update the code to test RemoveReactionFromAMessageResponse
