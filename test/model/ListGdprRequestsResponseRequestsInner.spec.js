...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.ListGdprRequestsResponseRequestsInner();
  });
  ...
  describe('ListGdprRequestsResponseRequestsInner', function() {
    it('should create an instance of ListGdprRequestsResponseRequestsInner', function() {
      // uncomment below and update the code to test ListGdprRequestsResponseRequestsInner
      //var instance = new SendbirdPlatformSdk.ListGdprRequestsResponseRequestsInner();
      //expect(instance).to.be.a(SendbirdPlatformSdk.ListGdprRequestsResponseRequestsInner);
    });
