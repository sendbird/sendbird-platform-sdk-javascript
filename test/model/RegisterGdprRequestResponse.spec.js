...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.RegisterGdprRequestResponse();
  });
  ...
  describe('RegisterGdprRequestResponse', function() {
    it('should create an instance of RegisterGdprRequestResponse', function() {
      // uncomment below and update the code to test RegisterGdprRequestResponse
      //var instance = new SendbirdPlatformSdk.RegisterGdprRequestResponse();
