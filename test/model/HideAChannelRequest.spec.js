...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.HideAChannelRequest();
  });
  ...
  describe('HideAChannelRequest', function() {
    it('should create an instance of HideAChannelRequest', function() {
      // uncomment below and update the code to test HideAChannelRequest
      //var instance = new SendbirdPlatformSdk.HideAChannelRequest();
      //expect(instance).to.be.a(SendbirdPlatformSdk.HideAChannelRequest);
    });
