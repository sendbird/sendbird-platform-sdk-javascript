...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.SendBirdGroupChannelChannel();
  });
  ...
  describe('SendBirdGroupChannelChannel', function() {
    it('should create an instance of SendBirdGroupChannelChannel', function() {
      // uncomment below and update the code to test SendBirdGroupChannelChannel
      //var instance = new SendbirdPlatformSdk.SendBirdGroupChannelChannel();
      //expect(instance).to.be.a(SendbirdPlatformSdk.SendBirdGroupChannelChannel);
    });
