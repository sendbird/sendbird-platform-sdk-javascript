...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.ResetChatHistoryResponse();
  });
  ...
  describe('ResetChatHistoryResponse', function() {
    it('should create an instance of ResetChatHistoryResponse', function() {
      // uncomment below and update the code to test ResetChatHistoryResponse
      //var instance = new SendbirdPlatformSdk.ResetChatHistoryResponse();
