...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.SendBirdThumbnailObject();
  });
  ...
  describe('SendBirdThumbnailObject', function() {
    it('should create an instance of SendBirdThumbnailObject', function() {
      // uncomment below and update the code to test SendBirdThumbnailObject
      //var instance = new SendbirdPlatformSdk.SendBirdThumbnailObject();
      //expect(instance).to.be.a(SendbirdPlatformSdk.SendBirdThumbnailObject);
    });
