...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.ViewPushPreferencesResponse();
  });
  ...
  describe('ViewPushPreferencesResponse', function() {
    it('should create an instance of ViewPushPreferencesResponse', function() {
      // uncomment below and update the code to test ViewPushPreferencesResponse
