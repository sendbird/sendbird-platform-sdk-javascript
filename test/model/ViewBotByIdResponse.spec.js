...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.ViewBotByIdResponse();
  });
  ...
  describe('ViewBotByIdResponse', function() {
    it('should create an instance of ViewBotByIdResponse', function() {
      // uncomment below and update the code to test ViewBotByIdResponse
      //var instance = new SendbirdPlatformSdk.ViewBotByIdResponse();
      //expect(instance).to.be.a(SendbirdPlatformSdk.ViewBotByIdResponse);
    });
