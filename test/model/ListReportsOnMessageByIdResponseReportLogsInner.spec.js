...
(function(root, factory) {
  ...
  describe('ListReportsOnMessageByIdResponseReportLogsInner', function() {
    it('should create an instance of ListReportsOnMessageByIdResponseReportLogsInner', function() {
      // uncomment below and update the code to test ListReportsOnMessageByIdResponseReportLogsInner
