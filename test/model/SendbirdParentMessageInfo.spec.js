...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.SendbirdParentMessageInfo();
  });
  ...
  describe('SendbirdParentMessageInfo', function() {
    it('should create an instance of SendbirdParentMessageInfo', function() {
      // uncomment below and update the code to test SendbirdParentMessageInfo
      //var instance = new SendbirdPlatformSdk.SendbirdParentMessageInfo();
      //expect(instance).to.be.a(SendbirdPlatformSdk.SendbirdParentMessageInfo);
    });
