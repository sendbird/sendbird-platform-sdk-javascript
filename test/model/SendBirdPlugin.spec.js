...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.SendBirdPlugin();
  });
  ...
  describe('SendBirdPlugin', function() {
    it('should create an instance of SendBirdPlugin', function() {
      // uncomment below and update the code to test SendBirdPlugin
      //var instance = new SendbirdPlatformSdk.SendBirdPlugin();
      //expect(instance).to.be.a(SendbirdPlatformSdk.SendBirdPlugin);
    });
