...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.UpdateExtraDataInAMessageRequest();
  });
  ...
  describe('UpdateExtraDataInAMessageRequest', function() {
    it('should create an instance of UpdateExtraDataInAMessageRequest', function() {
      // uncomment below and update the code to test UpdateExtraDataInAMessageRequest
      //var instance = new SendbirdPlatformSdk.UpdateExtraDataInAMessageRequest();
      //expect(instance).to.be.a(SendbirdPlatformSdk.UpdateExtraDataInAMessageRequest);
    });
