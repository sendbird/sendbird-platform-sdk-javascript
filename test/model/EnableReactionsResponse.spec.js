...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.EnableReactionsResponse();
  });
  ...
  describe('EnableReactionsResponse', function() {
    it('should create an instance of EnableReactionsResponse', function() {
      // uncomment below and update the code to test EnableReactionsResponse
