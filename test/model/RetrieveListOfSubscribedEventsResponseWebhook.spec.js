...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.RetrieveListOfSubscribedEventsResponseWebhook();
  });
  ...
  describe('RetrieveListOfSubscribedEventsResponseWebhook', function() {
    it('should create an instance of RetrieveListOfSubscribedEventsResponseWebhook', function() {
      // uncomment below and update the code to test RetrieveListOfSubscribedEventsResponseWebhook
      //var instance = new SendbirdPlatformSdk.RetrieveListOfSubscribedEventsResponseWebhook();
      //expect(instance).to.be.a(SendbirdPlatformSdk.RetrieveListOfSubscribedEventsResponseWebhook);
    });
