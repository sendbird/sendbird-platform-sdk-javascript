...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.UpdateFcmPushConfigurationByIdResponse();
  });
  ...
  describe('UpdateFcmPushConfigurationByIdResponse', function() {
    it('should create an instance of UpdateFcmPushConfigurationByIdResponse', function() {
      // uncomment below and update the code to test UpdateFcmPushConfigurationByIdResponse
