...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.SendbirdFile();
  });
  ...
  describe('SendbirdFile', function() {
    it('should create an instance of SendbirdFile', function() {
      // uncomment below and update the code to test SendbirdFile
      //var instance = new SendbirdPlatformSdk.SendbirdFile();
      //expect(instance).to.be.a(SendbirdPlatformSdk.SendbirdFile);
    });
