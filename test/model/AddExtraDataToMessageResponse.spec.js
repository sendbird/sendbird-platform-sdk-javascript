...
(function(root, factory) {
  ...
  describe('AddExtraDataToMessageResponse', function() {
    it('should create an instance of AddExtraDataToMessageResponse', function() {
      // uncomment below and update the code to test AddExtraDataToMessageResponse
      //var instance = new SendbirdPlatformSdk.AddExtraDataToMessageResponse();
