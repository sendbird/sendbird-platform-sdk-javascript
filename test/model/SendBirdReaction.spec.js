...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.SendBirdReaction();
  });
  ...
  describe('SendBirdReaction', function() {
    it('should create an instance of SendBirdReaction', function() {
      // uncomment below and update the code to test SendBirdReaction
      //var instance = new SendbirdPlatformSdk.SendBirdReaction();
      //expect(instance).to.be.a(SendbirdPlatformSdk.SendBirdReaction);
    });
