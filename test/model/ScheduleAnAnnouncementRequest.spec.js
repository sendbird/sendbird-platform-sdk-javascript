...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.ScheduleAnAnnouncementRequest();
  });
  ...
  describe('ScheduleAnAnnouncementRequest', function() {
    it('should create an instance of ScheduleAnAnnouncementRequest', function() {
      // uncomment below and update the code to test ScheduleAnAnnouncementRequest
      //var instance = new SendbirdPlatformSdk.ScheduleAnAnnouncementRequest();
      //expect(instance).to.be.a(SendbirdPlatformSdk.ScheduleAnAnnouncementRequest);
    });
    ...
    it('should have the property keepChannelHiddenForSender (base name: "keep_channel_hidden_for_sender")', function() {
      // uncomment below and update the code to test the property keepChannelHiddenForSender
      //var instance = new SendbirdPlatformSdk.ScheduleAnAnnouncementRequest();
      //expect(instance).to.be();
    });
