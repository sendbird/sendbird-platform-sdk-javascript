...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.SendBirdLogLevel();
  });
  ...
  describe('SendBirdLogLevel', function() {
    it('should create an instance of SendBirdLogLevel', function() {
      // uncomment below and update the code to test SendBirdLogLevel
      //var instance = new SendbirdPlatformSdk.SendBirdLogLevel();
      //expect(instance).to.be.a(SendbirdPlatformSdk.SendBirdLogLevel);
    });
