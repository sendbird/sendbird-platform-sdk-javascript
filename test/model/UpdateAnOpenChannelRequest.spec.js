...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.UpdateAnOpenChannelRequest();
  });
  ...
  describe('UpdateAnOpenChannelRequest', function() {
    it('should create an instance of UpdateAnOpenChannelRequest', function() {
      // uncomment below and update the code to test UpdateAnOpenChannelRequest
      //var instance = new SendbirdPlatformSdk.UpdateAnOpenChannelRequest();
      //expect(instance).to.be.a(SendbirdPlatformSdk.UpdateAnOpenChannelRequest);
    });
