...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.CreateABotResponse();
  });
  ...
  describe('CreateABotResponse', function() {
    it('should create an instance of CreateABotResponse', function() {
      // uncomment below and update the code to test CreateABotResponse
      //var instance = new SendbirdPlatformSdk.CreateABotResponse();
      //expect(instance).to.be.a(SendbirdPlatformSdk.CreateABotResponse);
    });
