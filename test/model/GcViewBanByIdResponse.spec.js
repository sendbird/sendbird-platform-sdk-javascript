...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.GcViewBanByIdResponse();
  });
  ...
  describe('GcViewBanByIdResponse', function() {
    it('should create an instance of GcViewBanByIdResponse', function() {
      // uncomment below and update the code to test GcViewBanByIdResponse
