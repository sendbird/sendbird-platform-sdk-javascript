...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.AddHmsPushConfigurationResponsePushConfigurationsInner();
  });
  ...
  describe('AddHmsPushConfigurationResponsePushConfigurationsInner', function() {
    it('should create an instance of AddHmsPushConfigurationResponsePushConfigurationsInner', function() {
      // uncomment below and update the code to test AddHmsPushConfigurationResponsePushConfigurationsInner
      //var instance = new SendbirdPlatformSdk.AddHmsPushConfigurationResponsePushConfigurationsInner();
      //expect(instance).to.be.a(SendbirdPlatformSdk.AddHmsPushConfigurationResponsePushConfigurationsInner);
    });
