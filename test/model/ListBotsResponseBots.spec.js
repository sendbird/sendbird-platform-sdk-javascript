...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.ListBotsResponseBots();
  });
  ...
  describe('ListBotsResponseBots', function() {
    it('should create an instance of ListBotsResponseBots', function() {
      // uncomment below and update the code to test ListBotsResponseBots
      //var instance = new SendbirdPlatformSdk.ListBotsResponseBots();
      //expect(instance).to.be.a(SendbirdPlatformSdk.ListBotsResponseBots);
    });
