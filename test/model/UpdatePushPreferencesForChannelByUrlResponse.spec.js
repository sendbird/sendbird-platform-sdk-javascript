...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.UpdatePushPreferencesForChannelByUrlResponse();
  });
  ...
  describe('UpdatePushPreferencesForChannelByUrlResponse', function() {
    it('should create an instance of UpdatePushPreferencesForChannelByUrlResponse', function() {
      // uncomment below and update the code to test UpdatePushPreferencesForChannelByUrlResponse
      //var instance = new SendbirdPlatformSdk.UpdatePushPreferencesForChannelByUrlResponse();
