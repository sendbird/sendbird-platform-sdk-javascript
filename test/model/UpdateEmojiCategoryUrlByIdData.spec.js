...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.UpdateEmojiCategoryUrlByIdData();
  });
  ...
  describe('UpdateEmojiCategoryUrlByIdData', function() {
    ...
    it('should have the property emojiCategoryId (base name: "emoji_category_id")', function() {
      // uncomment below and update the code to test the property emojiCategoryId
      //var instance = new SendbirdPlatformSdk.UpdateEmojiCategoryUrlByIdData();
