...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.ViewDataExportByIdResponse();
  });
  ...
  describe('ViewDataExportByIdResponse', function() {
    it('should create an instance of ViewDataExportByIdResponse', function() {
      // uncomment below and update the code to test ViewDataExportByIdResponse
      //var instance = new SendbirdPlatformSdk.ViewDataExportByIdResponse();
      //expect(instance).to.be.a(SendbirdPlatformSdk.ViewDataExportByIdResponse);
    });
