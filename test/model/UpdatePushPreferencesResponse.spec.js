...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.UpdatePushPreferencesResponse();
  });
  ...
  describe('UpdatePushPreferencesResponse', function() {
    it('should create an instance of UpdatePushPreferencesResponse', function() {
      // uncomment below and update the code to test UpdatePushPreferencesResponse
