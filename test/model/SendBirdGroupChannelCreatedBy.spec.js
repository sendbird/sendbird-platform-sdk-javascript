...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.SendBirdGroupChannelCreatedBy();
  });
  ...
  describe('SendBirdGroupChannelCreatedBy', function() {
    it('should create an instance of SendBirdGroupChannelCreatedBy', function() {
      // uncomment below and update the code to test SendBirdGroupChannelCreatedBy
      //var instance = new SendbirdPlatformSdk.SendBirdGroupChannelCreatedBy();
      //expect(instance).to.be.a(SendbirdPlatformSdk.SendBirdGroupChannelCreatedBy);
    });
