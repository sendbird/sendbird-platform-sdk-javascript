...
(function(root, factory) {
  ...
  describe('ListDataExportsByMessageChannelOrUserResponseExportedDataInnerFile', function() {
    it('should create an instance of ListDataExportsByMessageChannelOrUserResponseExportedDataInnerFile', function() {
      // uncomment below and update the code to test ListDataExportsByMessageChannelOrUserResponseExportedDataInnerFile
      //var instance = new SendbirdPlatformSdk.ListDataExportsByMessageChannelOrUserResponseExportedDataInnerFile();
