...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.CreateAChannelMetadataRequest();
  });
  ...
  describe('CreateAChannelMetadataRequest', function() {
    it('should create an instance of CreateAChannelMetadataRequest', function() {
      // uncomment below and update the code to test CreateAChannelMetadataRequest
