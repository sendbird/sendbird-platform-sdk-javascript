...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.CreateAGroupChannelRequest();
  });
  ...
  describe('CreateAGroupChannelRequest', function() {
    it('should create an instance of CreateAGroupChannelRequest', function() {
      // uncomment below and update the code to test CreateAGroupChannelRequest
      //var instance = new SendbirdPlatformSdk.CreateAGroupChannelRequest();
      //expect(instance).to.be.a(SendbirdPlatformSdk.CreateAGroupChannelRequest);
    });
