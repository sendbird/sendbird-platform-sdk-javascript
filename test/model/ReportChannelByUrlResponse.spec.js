...
(function(root, factory) {
  ...
  describe('ReportChannelByUrlResponse', function() {
    it('should create an instance of ReportChannelByUrlResponse', function() {
      // uncomment below and update the code to test ReportChannelByUrlResponse
