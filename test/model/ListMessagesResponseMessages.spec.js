...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.ListMessagesResponseMessages();
  });
  ...
  describe('ListMessagesResponseMessages', function() {
    it('should create an instance of ListMessagesResponseMessages', function() {
      // uncomment below and update the code to test ListMessagesResponseMessages
