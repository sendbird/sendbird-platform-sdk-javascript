...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.SendBirdDiscoveryObject();
  });
  ...
  describe('SendBirdDiscoveryObject', function() {
    it('should create an instance of SendBirdDiscoveryObject', function() {
      // uncomment below and update the code to test SendBirdDiscoveryObject
      //var instance = new SendbirdPlatformSdk.SendBirdDiscoveryObject();
      //expect(instance).to.be.a(SendbirdPlatformSdk.SendBirdDiscoveryObject);
    });
