...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.ListDataExportsByMessageChannelOrUserResponseExportedData();
  });
  ...
  describe('ListDataExportsByMessageChannelOrUserResponseExportedData', function() {
    it('should create an instance of ListDataExportsByMessageChannelOrUserResponseExportedData', function() {
      // uncomment below and update the code to test ListDataExportsByMessageChannelOrUserResponseExportedData
      //var instance = new SendbirdPlatformSdk.ListDataExportsByMessageChannelOrUserResponseExportedData();
      //expect(instance).to.be.a(SendbirdPlatformSdk.ListDataExportsByMessageChannelOrUserResponseExportedData);
    });
