...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.UpdatePushPreferencesForAChannelRequest();
  });
  ...
  describe('UpdatePushPreferencesForAChannelRequest', function() {
    it('should create an instance of UpdatePushPreferencesForAChannelRequest', function() {
      // uncomment below and update the code to test UpdatePushPreferencesForAChannelRequest
      //var instance = new SendbirdPlatformSdk.UpdatePushPreferencesForAChannelRequest();
