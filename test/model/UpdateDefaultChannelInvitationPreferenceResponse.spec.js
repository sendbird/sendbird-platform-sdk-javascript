...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.UpdateDefaultChannelInvitationPreferenceResponse();
  });
  ...
  describe('UpdateDefaultChannelInvitationPreferenceResponse', function() {
    it('should create an instance of UpdateDefaultChannelInvitationPreferenceResponse', function() {
      // uncomment below and update the code to test UpdateDefaultChannelInvitationPreferenceResponse
