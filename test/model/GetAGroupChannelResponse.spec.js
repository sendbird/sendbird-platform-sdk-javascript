...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.GetAGroupChannelResponse();
  });
  ...
  describe('GetAGroupChannelResponse', function() {
    it('should create an instance of GetAGroupChannelResponse', function() {
      // uncomment below and update the code to test GetAGroupChannelResponse
      //var instance = new SendbirdPlatformSdk.GetAGroupChannelResponse();
      //expect(instance).to.be.a(SendbirdPlatformSdk.GetAGroupChannelResponse);
    });
