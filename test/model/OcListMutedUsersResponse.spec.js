...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.OcListMutedUsersResponse();
  });
  ...
  describe('OcListMutedUsersResponse', function() {
    it('should create an instance of OcListMutedUsersResponse', function() {
      // uncomment below and update the code to test OcListMutedUsersResponse
      //var instance = new SendbirdPlatformSdk.OcListMutedUsersResponse();
