...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.MigrateMessagesRequestMessagesInner();
  });
  ...
  describe('MigrateMessagesRequestMessagesInner', function() {
    it('should create an instance of MigrateMessagesRequestMessagesInner', function() {
      // uncomment below and update the code to test MigrateMessagesRequestMessagesInner
      //var instance = new SendbirdPlatformSdk.MigrateMessagesRequestMessagesInner();
      //expect(instance).to.be.a(SendbirdPlatformSdk.MigrateMessagesRequestMessagesInner);
    });
