...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.GcListMutedUsersResponse();
  });
  ...
  describe('GcListMutedUsersResponse', function() {
    it('should create an instance of GcListMutedUsersResponse', function() {
      // uncomment below and update the code to test GcListMutedUsersResponse
      //var instance = new SendbirdPlatformSdk.GcListMutedUsersResponse();
