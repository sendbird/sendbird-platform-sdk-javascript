...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.GetStatisticsResponse();
  });
  ...
  describe('GetStatisticsResponse', function() {
    it('should create an instance of GetStatisticsResponse', function() {
      ...
      //var instance = new SendbirdPlatformSdk.GetStatisticsResponse();
      //expect(instance).to.be.a(SendbirdPlatformSdk.GetStatisticsResponse);
    });
