...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.ListReportsResponseReportLogs();
  });
  ...
  describe('ListReportsResponseReportLogs', function() {
    it('should create an instance of ListReportsResponseReportLogs', function() {
      // uncomment below and update the code to test ListReportsResponseReportLogs
