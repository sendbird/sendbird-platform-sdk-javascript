...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.UpdatePushPreferencesRequest();
  });
  ...
  describe('UpdatePushPreferencesRequest', function() {
    it('should create an instance of UpdatePushPreferencesRequest', function() {
      // uncomment below and update the code to test UpdatePushPreferencesRequest
      //var instance = new SendbirdPlatformSdk.UpdatePushPreferencesRequest();
      //expect(instance).to.be.a(SendbirdPlatformSdk.UpdatePushPreferencesRequest);
    });
