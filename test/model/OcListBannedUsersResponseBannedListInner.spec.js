...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.OcListBannedUsersResponseBannedListInner();
  });
  ...
  describe('OcListBannedUsersResponseBannedListInner', function() {
    it('should create an instance of OcListBannedUsersResponseBannedListInner', function() {
      // uncomment below and update the code to test OcListBannedUsersResponseBannedListInner
