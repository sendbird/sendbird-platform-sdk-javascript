...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.BlockAUserRequest();
  });
  ...
  describe('BlockAUserRequest', function() {
    it('should create an instance of BlockAUserRequest', function() {
      // uncomment below and update the code to test BlockAUserRequest
      //var instance = new SendbirdPlatformSdk.BlockAUserRequest();
      //expect(instance).to.be.a(SendbirdPlatformSdk.BlockAUserRequest);
    });
