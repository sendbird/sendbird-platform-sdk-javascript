...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.SendAMessageRequest();
  });
  ...
  describe('SendAMessageRequest', function() {
    it('should create an instance of SendAMessageRequest', function() {
      // uncomment below and update the code to test SendAMessageRequest
      //var instance = new SendbirdPlatformSdk.SendAMessageRequest();
      //expect(instance).to.be.a(SendbirdPlatformSdk.SendAMessageRequest);
    });
