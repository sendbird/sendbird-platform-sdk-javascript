...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.InlineResponse2002PushConfigurations();
  });
  ...
  describe('InlineResponse2002PushConfigurations', function() {
    it('should create an instance of InlineResponse2002PushConfigurations', function() {
      // uncomment below and update the code to test InlineResponse2002PushConfigurations
      //var instance = new SendbirdPlatformSdk.InlineResponse2002PushConfigurations();
      //expect(instance).to.be.a(SendbirdPlatformSdk.InlineResponse2002PushConfigurations);
    });
