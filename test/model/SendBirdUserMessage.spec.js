...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.SendBirdUserMessage();
  });
  ...
  describe('SendBirdUserMessage', function() {
    it('should create an instance of SendBirdUserMessage', function() {
      // uncomment below and update the code to test SendBirdUserMessage
      //var instance = new SendbirdPlatformSdk.SendBirdUserMessage();
      //expect(instance).to.be.a(SendbirdPlatformSdk.SendBirdUserMessage);
    });
