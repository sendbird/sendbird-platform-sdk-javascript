...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.SendBirdGroupChannelFilterStaticMemberStateFilter();
  });
  ...
  describe('SendBirdGroupChannelFilterStaticMemberStateFilter', function() {
    it('should create an instance of SendBirdGroupChannelFilterStaticMemberStateFilter', function() {
      // uncomment below and update the code to test SendBirdGroupChannelFilterStaticMemberStateFilter
      //var instance = new SendbirdPlatformSdk.SendBirdGroupChannelFilterStaticMemberStateFilter();
      //expect(instance).to.be.a(SendbirdPlatformSdk.SendBirdGroupChannelFilterStaticMemberStateFilter);
    });
