...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.RegisterAndScheduleDataExportResponse();
  });
  ...
  describe('RegisterAndScheduleDataExportResponse', function() {
    it('should create an instance of RegisterAndScheduleDataExportResponse', function() {
      // uncomment below and update the code to test RegisterAndScheduleDataExportResponse
