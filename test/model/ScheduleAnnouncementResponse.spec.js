...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.ScheduleAnnouncementResponse();
  });
  ...
  describe('ScheduleAnnouncementResponse', function() {
    it('should create an instance of ScheduleAnnouncementResponse', function() {
      // uncomment below and update the code to test ScheduleAnnouncementResponse
      //var instance = new SendbirdPlatformSdk.ScheduleAnnouncementResponse();
      //expect(instance).to.be.a(SendbirdPlatformSdk.ScheduleAnnouncementResponse);
    });
