...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.ListRegistrationOrDeviceTokensResponse();
  });
  ...
  describe('ListRegistrationOrDeviceTokensResponse', function() {
    it('should create an instance of ListRegistrationOrDeviceTokensResponse', function() {
      // uncomment below and update the code to test ListRegistrationOrDeviceTokensResponse
