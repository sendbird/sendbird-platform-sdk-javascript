...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendbirdPlatformSdk.SendAdminMessageRequestBody();
  });
  ...
  describe('SendAdminMessageRequestBody', function() {
    it('should create an instance of SendAdminMessageRequestBody', function() {
      // uncomment below and update the code to test SendAdminMessageRequestBody
      //var instance = new SendbirdPlatformSdk.SendAdminMessageRequestBody();
      //expect(instance).to.be.a(SendbirdPlatformSdk.SendAdminMessageRequestBody);
    });
